  ...
  return (
    <div className="page">
      <div className="page-header">
        ...
        {!isOwner && (
          <button className="icon-btn" onClick={() => setShowReport(!showReport)} style={{ marginLeft: isOwner ? 0 : 'auto', color: 'var(--text-muted)' }} title={t('report.report_post')}>
            <Flag size={18} />
          </button>
        )}
      </div>
          ...
          <div style={{
            ...
            {REPORT_REASONS.map(r => (
              <div
                ...
                style={{
                  ...
                  background: reportReason === r.value ? 'rgba(239,68,68,0.08)' : 'transparent',
                }}
              >
                <div style={{
                  width: 16, height: 16, borderRadius: 8,
                  border: reportReason === r.value ? '2px solid #ef4444' : '2px solid var(--border)',
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 8, padding: '10px 0', fontWeight: 600, fontSize: 13,
