export const fr: Record<string, string> = {
  ...
  'proxy.clear': 'Effacer',
  'proxy.hint': "Après la configuration d'un proxy, l'application acheminera le trafic via celui-ci. Prend en charge SOCKS5, HTTP et HTTPS. Jusqu'à 5 proxys peuvent être enregistrés.",
