export const es: Record<string, string> = {
  ...
  'chat.group_unencrypted_warning': 'El chat grupal no está cifrado. Se pueden añadir bots. No compartas información personal privada.',
  ...
  'group.encryption': 'Modo de cifrado', 'group.encryption_on': 'Cifrado de extremo a extremo activado', 'group.encryption_off': 'Sin cifrado',
  'group.encryption_switch_confirm': 'Cambiar el modo de cifrado eliminará todo el historial de chat. ¿Continuar?',
  'group.encryption_bot_warning': 'Una vez activado el cifrado en un grupo, los bots no pueden usarse. Desactiva el cifrado para volver a usar bots.',
  'group.encryption_changed': 'Modo de cifrado cambiado. El historial de chat ha sido eliminado.',
  'group.encryption_desc': 'Los mensajes están cifrados con Sender Keys. Solo los miembros del grupo pueden leerlos.',
  'group.encrypted_banner': 'El chat grupal está cifrado. Los bots no pueden usarse. Incluso con cifrado, no compartas información personal privada.',
  ...
  'proxy.clear': 'Borrar',
  'proxy.hint': 'Tras configurar un proxy, la app enrutará el tráfico a través de él. Compatible con SOCKS5, HTTP y HTTPS. Se pueden guardar hasta 5 proxies.',
