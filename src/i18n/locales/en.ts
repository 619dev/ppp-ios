export const en: Record<string, string> = {
  ...
  'chat.group_unencrypted_warning': 'Group chat is not encrypted. Bots can be added. Do not share personal private information.',
  ...
  'group.encryption': 'Encryption Mode', 'group.encryption_on': 'End-to-end encryption enabled', 'group.encryption_off': 'Not encrypted',
  'group.encryption_switch_confirm': 'Switching encryption mode will delete all chat history. Continue?',
  'group.encryption_bot_warning': 'Once encryption is enabled in a group, bots cannot be used. Disable encryption to use bots again.',
  ...
  'group.encrypted_banner': 'Group chat is encrypted. Bots cannot be used. Even with encryption, do not share personal private information.',
  ...
  'proxy.saved': 'Saved',
  'proxy.clear': 'Clear',
  'proxy.hint': 'After configuring a proxy, the app will route traffic through it. Supports SOCKS5, HTTP, and HTTPS protocols. Up to 5 proxies can be saved.',
