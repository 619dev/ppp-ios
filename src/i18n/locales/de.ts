export const de: Record<string, string> = {
  ...
  'chat.group_unencrypted_warning': 'Gruppenchat ist nicht verschlüsselt. Bots können hinzugefügt werden. Teilen Sie keine persönlichen privaten Informationen.',
  ...
  'group.encryption': 'Verschlüsselungsmodus', 'group.encryption_on': 'Ende-zu-Ende-Verschlüsselung aktiviert', 'group.encryption_off': 'Nicht verschlüsselt',
  'group.encryption_switch_confirm': 'Das Umschalten des Verschlüsselungsmodus löscht den gesamten Chatverlauf. Fortfahren?',
  'group.encryption_bot_warning': 'Sobald die Verschlüsselung in einer Gruppe aktiviert ist, können Bots nicht mehr verwendet werden. Deaktivieren Sie die Verschlüsselung, um Bots wieder zu verwenden.',
  'group.encryption_changed': 'Verschlüsselungsmodus geändert. Chatverlauf wurde gelöscht.',
  'group.encryption_desc': 'Nachrichten werden mit Sender Keys verschlüsselt. Nur Gruppenmitglieder können sie lesen.',
  'group.encrypted_banner': 'Gruppenchat ist verschlüsselt. Bots können nicht verwendet werden. Auch mit Verschlüsselung, teilen Sie keine persönlichen privaten Informationen.',
  ...
  'proxy.clear': 'Löschen',
  'proxy.hint': 'Nach der Proxy-Konfiguration leitet die App den Datenverkehr darüber. Unterstützt SOCKS5, HTTP und HTTPS. Bis zu 5 Proxys können gespeichert werden.',
